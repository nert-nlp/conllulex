...
Welcome to ``conllulex`` contributor's guide.
...
If you experience bugs or general issues with ``conllulex``, please have a look
...
You can help improve ``conllulex`` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

``conllulex`` documentation uses Sphinx_ as its main documentation compiler.
...
.. todo:: If your project is hosted on GitHub, you can also mention the following tip:
   ...
   .. tip::
      ...
      propose changes in ``conllulex``'s files. While this mechanism can
...
#. Clone this copy to your local disk::
    ...
    git clone git@github.com:YourLogin/conllulex.git
    cd conllulex
...
#. Install |pre-commit|_::
   ...
   ``conllulex`` comes with a lot of hooks configured to automatically help the
...
.. _repository: https://github.com/<USERNAME>/conllulex
.. _issue tracker: https://github.com/<USERNAME>/conllulex/issues
.. <-- end -->
